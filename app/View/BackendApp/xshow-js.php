...
<?php if (isset($prevId)): ?>
					><a href="/xfocus-js/<?php echo $propertyId; ?>/<?php echo $prevId; ?>"><img id="left" class="navigation small enabled" src="/assets/img/left.png" data-show="/assets/img/left.png" data-hide="/assets/img/user-select-none.png"/></a
<?php else: ?>
					><a data-href="/xfocus-js/<?php echo $propertyId; ?>/{prevId}"><img id="left" class="navigation small" src="/assets/img/user-select-none.png" data-show="/assets/img/left.png" data-hide="/assets/img/user-select-none.png"/></a
<?php endif; ?>
	...
	<?php endforeach; ?>
<?php if (isset($nextId)): ?>
					><a href="/xfocus-js/<?php echo $propertyId; ?>/<?php echo $nextId; ?>"><img id="right" class="navigation small enabled" src="/assets/img/right.png" data-show="/assets/img/right.png" data-hide="/assets/img/user-select-none.png"/></a
<?php else: ?>
					><a data-href="/xfocus-js/<?php echo $propertyId; ?>/{nextId}"><img id="right" class="navigation small" src="/assets/img/user-select-none.png" data-show="/assets/img/right.png" data-hide="/assets/img/user-select-none.png"/></a
<?php endif; ?>
		></div>
